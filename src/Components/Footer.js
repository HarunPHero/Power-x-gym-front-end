...
const Footer = () => {
  return (
    <div className="bg-dark py-5">
      <footer className="footer p-10 text-light space-x-2 ...">
        <div>
        ...
        <div>
          ...
          <a className="link link-hover">Email Support</a>
        ...
        <div>
          <span className="footer-title">Digital Resources</span>
          <a className="link link-hover">Articles</a>
          <a className="link link-hover">E-books</a>
        
        </div>
        <div>
          <span className="footer-title">Connnect With Us</span>
      ...
      <a><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"></path></svg></a>
        ...
        <div>
         ...
         <p>Get execlusive news, features and updates from The Shredder Weight Loss Academy.</p>
        
        </div> 
        
      </footer>
      <p className="text-light text-center texl-2xl pt-8">© 2023 Power-X-Gym, All Rights Reserved.</p>
    </div>
  );
};
